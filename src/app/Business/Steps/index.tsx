...
const BUSINESS_STEPS_COTENT = [
    {
        imageSource: '/image_resources/Business/checklist.svg',
        title: 'THE SEARCH',
    ...
    {
        imageSource: '/image_resources/Business/filter_resources.svg',
    ...
    {
        imageSource: '/image_resources/Business/insight.svg',
...
export const BusinessSteps = () => {
    return (
        <div className='peeps-secondary-bg-dark flex justify-between items-between py-12'>
